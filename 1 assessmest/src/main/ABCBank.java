	...
	*/
	protected String askClientName() {
		do {
			...
			System.out.printf("\nError: Client's name should be at least single character.\n");
		} while (true);
	}
	...
	protected double askDepositeAmount() {
		do {
			...
			try {
				...
				System.out.printf("\nError: Deposite amount should be a greater than 0 (zero).\n");
			} catch (NumberFormatException e) {
				System.out.printf("\nError: Deposite amount should be a valid number.\n");
			}
		} while (true);
	}
	...
	protected int askNumberOfTerms() {
		do {
			...
			try {
				...
				System.out.printf("\nError: Terms must be greater than 0 (zero).\n");
			} catch (NumberFormatException e) {
				System.out.println("\nError: Terms must be a valid integer.\n");
			}
		} while (true);
	}
