...
/**
* This class provides a Command Line Interface (CLI) to help 
* calculate and display the entry charge for each family group
* and also display the total takings for a sequence of groups
*
* @version 0.1
...
public class ZooTicket {
	...
	/**
    * Method to run indefinitely to compute and display group
    * entry charge and total takings of all groups
    */
	public void run() {
